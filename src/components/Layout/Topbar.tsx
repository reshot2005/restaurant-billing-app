import { Bell, Search, ChevronDown, Plus, DollarSign, ShoppingCart } from "lucide-react";
...
export function Topbar({ onQuickAction, onNavigateToPOS }: TopbarProps) {
    ...
    <div className="h-16 bg-white/80 backdrop-blur-xl border-b border-border/50 fixed top-0 right-0 left-64 z-10 flex items-center px-6 gap-6 shadow-sm">
      ...
      <div className="flex items-center gap-3">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button variant="ghost" className="gap-2">
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#7DD3FC] to-[#FBCFE8] flex items-center justify-center">
